...
from huawei.exp.exp_client import Exp_Client
...
setting = 'huawei_{}_ft{}_ts{}_fs{}_os{}_pl{}_epoch{}_lr{}_bs{}_el{}_nh{}_dp{}_ffn{}_loss{}_revin{}'.format(
    config.model_name,
    config.features,
    config.timestep,
    config.feature_size,
